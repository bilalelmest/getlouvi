          ...
          {isInAppBrowser ? (
            <div className="text-center p-4 rounded-lg bg-amber-50 border border-amber-200">
              <p className="text-sm text-amber-800 mb-3">
                La connexion Google ne fonctionne pas depuis cette application. Ouvrez cette page dans votre navigateur.
              </p>
              <button
                type="button"
                onClick={() => {
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-amber-600 text-white text-sm font-medium hover:bg-amber-700 transition-colors duration-200"
              >
